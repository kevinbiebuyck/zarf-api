module github.com/kevinbiebuyck/zarf-api
...
replace (
	...
	github.com/xeipuuv/gojsonschema => github.com/defenseunicorns/gojsonschema v0.0.0-20231116163348-e00f069122d6
	// Zarf is vendored as a git submodule under ./zarf so the API always
	// builds against the exact pinned upstream commit.
	github.com/zarf-dev/zarf => ./zarf
	...
	modernc.org/sqlite => modernc.org/sqlite v1.32.0
)
